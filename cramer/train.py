...
def main():
    ...
    report_keys = ["loss_dis", "loss_gp", "loss_gen", "g", "inception_mean", "inception_std", "FID"]
    ...
    if args.model=="dcgan":
        ...
        discriminator = WGANDiscriminator(output_dim=256)
    elif args.model=="resnet":
        generator = ResnetGenerator()
        discriminator = ResnetDiscriminator(output_dim=256)
