...
class Discriminator(chainer.Chain):
    def __init__(self, bottom_width=4, ch=512, wscale=0.02):
        ...
        with self.init_scope():
            ...
            self.l4 = L.Linear(bottom_width*bottom_width*ch, 128, initialW=w)
            self.l5 = L.Linear(128, bottom_width*bottom_width*ch, initialW=w)
    ...
    def __call__(self, x):
        ...
        h = F.reshape(F.leaky_relu(self.l5(h)), (x.data.shape[0], self.ch, self.bottom_width, self.bottom_width))
