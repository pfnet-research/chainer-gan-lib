...
from common.evaluation import sample_generate, sample_generate_light, calc_inception
...
def main():
    ...
    report_keys = ["loss_dis", "loss_gen", "kt", "measure", "inception_mean", "inception_std"]
    max_iter = args.max_iter

    if args.gpu >= 0:
        chainer.cuda.get_device_from_id(args.gpu).use()

    generator = Generator(z_distribution="uniform", use_bn=False)
